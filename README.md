...
[![Download](https://img.shields.io/badge/Download-v4.4.0-%23007ec6)](https://github.com/tegonal/scripts/releases/tag/v4.4.0)
...
version: [README of v4.4.0](https://github.com/tegonal/scripts/tree/v4.4.0/README.md).
...
```bash
export TEGONAL_SCRIPTS_VERSION="v4.4.0"
