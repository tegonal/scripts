...
[![Download](https://img.shields.io/badge/Download-v3.0.1-%23007ec6)](https://github.com/tegonal/scripts/releases/tag/v3.0.1)
...
version: [README of v3.0.1](https://github.com/tegonal/scripts/tree/v3.0.1/README.md).
...
```bash
export TEGONAL_SCRIPTS_VERSION="v3.0.1"
