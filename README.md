...
[![Download](https://img.shields.io/badge/Download-v0.11.0-%23007ec6)](https://github.com/tegonal/scripts/releases/tag/v0.11.0)
...
version.
For instance, the [README of v0.11.0](https://github.com/tegonal/scripts/tree/v0.11.0/README.md).
...
```bash
export TEGONAL_SCRIPTS_VERSION="v0.11.0"
