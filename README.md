...
<!-- auto-generated, do not modify here but in /home/tegonal/projects/ght/scripts/./utility/parse-args.sh -->
```bash
#!/usr/bin/env bash
...
<!-- auto-generated, do not modify here but in /home/tegonal/projects/ght/scripts/./utility/parse-fn-args.sh -->
```bash
#!/usr/bin/env bash
...
<!-- auto-generated, do not modify here but in /home/tegonal/projects/ght/scripts/./utility/replace-snippet.sh -->
```bash
#!/usr/bin/env bash
