<!-- for main -->
<!--
[![Download](https://img.shields.io/badge/Download-v0.13.1-%23007ec6)](https://github.com/tegonal/scripts/releases/tag/v0.13.1)
...
version.
For instance, the [README of v0.13.1](https://github.com/tegonal/scripts/tree/v0.13.1/README.md).
...
```bash
export TEGONAL_SCRIPTS_VERSION="v0.13.1"
