...
[![Download](https://img.shields.io/badge/Download-v0.14.6-%23007ec6)](https://github.com/tegonal/scripts/releases/tag/v0.14.6)
...
version.
For instance, the [README of v0.14.6](https://github.com/tegonal/scripts/tree/v0.14.6/README.md).
...
```bash
export TEGONAL_SCRIPTS_VERSION="v0.14.6"
