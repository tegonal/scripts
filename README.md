...
[![Download](https://img.shields.io/badge/Download-v0.14.2-%23007ec6)](https://github.com/tegonal/scripts/releases/tag/v0.14.2)
...
version.
For instance, the [README of v0.14.2](https://github.com/tegonal/scripts/tree/v0.14.2/README.md).
...
```bash
export TEGONAL_SCRIPTS_VERSION="v0.14.2"
