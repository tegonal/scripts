<!-- for main -->
<!--
[![Download](https://img.shields.io/badge/Download-v4.12.3-%23007ec6)](https://github.com/tegonal/scripts/releases/tag/v4.12.3)
...
Latest version: [README of v4.12.3](https://github.com/tegonal/scripts/tree/v4.12.3/README.md).
...
```bash
export TEGONAL_SCRIPTS_VERSION="v4.12.3"
