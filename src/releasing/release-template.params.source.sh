...
# keep in sync with src/releasing/release-template.params-definition.source.sh
local releaseHook nextVersion prepareOnly beforePrFn prepareNextDevCycleFn afterVersionUpdateHook
