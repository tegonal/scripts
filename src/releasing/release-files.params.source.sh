...
#######  Description  #############
#
# defines local variables for the params defined in release-files.params-definition.source.sh
#
###################################
...
# keep in sync with src/releasing/release-files.params-definition.source.sh
local key findForSigning
